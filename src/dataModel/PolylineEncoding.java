	...
	/**
	  ...
	  public static List<LatLng> decode(final String encodedPath) {
	    ...
	    while (index < len) {
	      ...
	      path.add(new LatLng(String.valueOf(lat * 1e-5), 
	    		  String.valueOf(lng * 1e-5)));
	    }
	  ...
	  public static String encode(final List<LatLng> path) {
	    ...
	    for (final LatLng point : path) {
	      long lat = Math.round(point.getLat().longValue() * 1e5);
	      long lng = Math.round(point.getLng().longValue() * 1e5);
